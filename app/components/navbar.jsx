  ...
  return (
    <nav>
        <div className="flex justify-between mx-2 w-full">
          ...
          <div className="px-4 cursor-pointer text-slate-950 block md:hidden relative bg-inherit text-sm">
            <button onClick={openMenu} className="flex flex-col justify-end items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 5.25h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5" />
              </svg>     
            </button> 
            <div className="absolute center-0 selection:w-full shadow-card transition-all duration-500 ease-linear border-[.5px] border-light">
              {isOpen &&
                <div className="">
